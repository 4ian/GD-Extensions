...
/**
 * PathfindingRuntimeAutomatism represents an automatism allowing objects to be
...
gdjs.PathfindingRuntimeAutomatism.thisIsARuntimeAutomatismConstructor = "PlatformAutomatism::PathfindingAutomatism";
 ...
 */
gdjs.PathfindingRuntimeAutomatism.prototype._isCollidingWith = function(candidates, exceptThisOne, excludeJumpThrus)
{
 ...
 */
gdjs.PathfindingRuntimeAutomatism.prototype._isCollidingWithExcluding = function(candidates, exceptTheseOnes)
{
    for (var k in candidates) {
        if (candidates.hasOwnProperty(k)) {
            var platform = candidates[k];
 ...
 */
gdjs.PathfindingRuntimeAutomatism.prototype._updateCollidingObjects = function()
{
 ...
 * @private
 */
gdjs.PathfindingRuntimeAutomatism.prototype._updateOverlappedJumpThru = function()
{
    for (var k in this._potentialCollidingObjects) {
        if (this._potentialCollidingObjects.hasOwnProperty(k)) {
            var platform = this._potentialCollidingObjects[k];
 ...
 * @private
 */
gdjs.PathfindingRuntimeAutomatism.prototype._isOverlappingLadder = function() {
    for (var k in this._potentialCollidingObjects) {
        if (this._potentialCollidingObjects.hasOwnProperty(k)) {
            var platform = this._potentialCollidingObjects[k];
 ...
 * @private
 */
gdjs.PathfindingRuntimeAutomatism.prototype._updatePotentialCollidingObjects = function(maxMovementLength)
{
...
gdjs.PathfindingRuntimeAutomatism.prototype.simulateControl = function(input) {
...
gdjs.PathfindingRuntimeAutomatism.prototype.getGravity = function()
{
    return this._gravity;
};
gdjs.PathfindingRuntimeAutomatism.prototype.getMaxFallingSpeed = function()
{
...
gdjs.PathfindingRuntimeAutomatism.prototype.getDeceleration = function()
{
...
gdjs.PathfindingRuntimeAutomatism.prototype.getJumpSpeed = function()
{
    return this._jumpSpeed;
};

gdjs.PathfindingRuntimeAutomatism.prototype.setGravity = function(gravity)
{
    this._gravity = gravity;
};
gdjs.PathfindingRuntimeAutomatism.prototype.setMaxFallingSpeed = function(maxFallingSpeed)
{
...
gdjs.PathfindingRuntimeAutomatism.prototype.setDeceleration = function(deceleration)
{
...
gdjs.PathfindingRuntimeAutomatism.prototype.setJumpSpeed = function(jumpSpeed)
{
    this._jumpSpeed = jumpSpeed;
};
gdjs.PathfindingRuntimeAutomatism.prototype.setCanJump = function()
{
    this._canJump = true;
};

gdjs.PathfindingRuntimeAutomatism.prototype.ignoreDefaultControls = function(ignore)
{
    this._ignoreDefaultControls = ignore;
};

gdjs.PathfindingRuntimeAutomatism.prototype.simulateLeftKey = function()
{
    this._leftKey = true;
};
gdjs.PathfindingRuntimeAutomatism.prototype.simulateRightKey = function()
{
    this._rightKey = true;
};
gdjs.PathfindingRuntimeAutomatism.prototype.simulateLadderKey = function()
{
    this._ladderKey = true;
};
gdjs.PathfindingRuntimeAutomatism.prototype.simulateUpKey = function()
{
    this._upKey = true;
};
gdjs.PathfindingRuntimeAutomatism.prototype.simulateDownKey = function()
{
    this._downKey = true;
};
gdjs.PathfindingRuntimeAutomatism.prototype.simulateJumpKey = function()
{
    this._jumpKey = true;
};

gdjs.PathfindingRuntimeAutomatism.prototype.isOnFloor = function()
{
    return this._isOnFloor;
};
gdjs.PathfindingRuntimeAutomatism.prototype.isOnLadder = function()
{
    return this._isOnLadder;
};
gdjs.PathfindingRuntimeAutomatism.prototype.isJumping = function()
{
    return this._jumping;
};
gdjs.PathfindingRuntimeAutomatism.prototype.isFalling = function()
{
    return !this._isOnFloor && !this._isOnLadder && (!this._jumping || this._currentJumpSpeed < this._currentFallSpeed);
};
gdjs.PathfindingRuntimeAutomatism.prototype.isMoving = function()
{
